...
public class CameraActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
		...
		layout.addView(mPreview, new RelativeLayout.LayoutParams(LayoutParams.FILL_PARENT, LayoutParams.FILL_PARENT));
		...
		btn_cancel_param.addRule(RelativeLayout.ALIGN_TOP, ID_BTN_CANCEL_CAMERA);
