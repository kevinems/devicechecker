...
public final class Alarm implements Parcelable {
    ...
    public void writeToParcel(Parcel p, int flags) {
        ...
        p.writeString(label);
        p.writeString(mClsOfApp.getCls());
    ...
    public static class Columns implements BaseColumns {
        ...
        static final String[] ALARM_QUERY_COLUMNS = {
            ...
            ENABLED, VIBRATE, MESSAGE, APPCLS,ALERT};
        ...
        public static final int ALARM_APPCLS_INDEX = 8;
    }
    //////////////////////////////
    ...
    //public int	apppositon;
    //public int      appposition;
    public ClsOfApp mClsOfApp;
    public String     label;
    public Uri        alert;
    ...
    public Alarm(Cursor c) {
       ...
       //vibrate = c.getInt(Columns.ALARM_VIBRATE_INDEX) == 1;
        //added by frankiewei
        //appposition = c.getInt(Columns.ALARM_APPPOSITION_INDEX);
        
        mClsOfApp = new ClsOfApp(c.getString(Columns.ALARM_APPCLS_INDEX));
        label = c.getString(Columns.ALARM_MESSAGE_INDEX);
        String alertString = c.getString(Columns.ALARM_ALERT_INDEX);
        if (alertString.equals(ALARM_ALERT_SILENT)) {
    ...
    public Alarm(Parcel p) {
        ...
        time = p.readLong();
      //vibrate = p.readInt() == 1;
       // appposition = p.readInt();
        mClsOfApp = new ClsOfApp(p.readString());     
        label = p.readString();
	...
	static final class ClsOfApp{
		private String mCls;
		
		public ClsOfApp(String cls) {
			mCls = cls;
		}
